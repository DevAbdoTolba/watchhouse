...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "clip":       "🎥 {where}",
        "angles_album":"🎬 All angles  {when}",
        "pair_clips":  "🎥 Both angles  {when}",
        "requested_by":" · for {who}",
        "collision":  "🔗 {name} — {direction}  {when}",
        "btn_capture":"🎥 Capture",
        "btn_all":    "🎬 All cameras",
        "cb_wait":    "⏳ Sending…",
    ...
    "ar": {
        ...
        "clip":       "🎥 {where}",
        "angles_album":"🎬 كل الزوايا  {when}",
        "pair_clips":  "🎥 الزاويتان  {when}",
        "requested_by":" · لـ {who}",
        "collision":  "🔗 {name} — {direction}  {when}",
        "btn_capture":"🎥 الفيديو",
